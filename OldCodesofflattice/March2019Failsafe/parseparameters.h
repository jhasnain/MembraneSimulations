...
*/
  ...
  {"ChemPots"  , 'q', "LIST"  , 0, "Chemical potential of each species on the membrane, the first [NumPType] entries are assigned to the bottom mesh, the second set to the top" },
  {"GCRate"    , 'r', "DOUBLE"  , 0, "Probability of performing grand canonical MC move" },
  
  {"OutDir"    , 's', "DIR"   , 0, "Output directory" },
  {"Tag"       , 't', "STR"   , 0, "Cosmetic tag to add to filenames" },
  {"framenums" , 'u', "INT"   , 0, "Number of frames in video" },
  {"datnums"   , 'v', "INT"   , 0, "Number of datapoints in datafile"},
  
  {"Input"     , 'w', "FILE"  , 0, "Input filename" },
  {"Equil"     , 'x', "OPT"   , 0, "Equilibration option [YES/NO]"},
  
  {"MCSweeps"  , 'y', "INT"   , 0, "Number of MC sweeps to perform" },
  {"BiasStr"   , 'z', "DOUBLE", 0, "Strength of bias applied on mesh distance [kBT]"},
  {"BiasType"  , '1', "STR"   , 0, "Type of Bias to apply on membranes: Harmonic, Point, or Linear"},
  {"BiasCenter", '2', "DOUBLE", 0, "Shift parameter of bias potential"},
  
  {"ErrorCheck", '3', "STR"   , 0, "Check all configurations"},
  {"SEED"      , '4', "LONG INT", 0, "Random seed for rng"},
  {0}
};
